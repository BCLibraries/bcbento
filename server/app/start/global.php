...
/*
 * Bind services into IoC container
 */
$app->bind(
    'BCLib\PrimoServices\PrimoServices',
    function ($app) {
...
$app->bind(
    'BCLib\PrimoServices\QueryBuilder',
    function ($app) {
        return new \BCLib\PrimoServices\QueryBuilder($_ENV['PRIMO_INSTITUTION']);
    }
);
...
$app->bind(
    'TFN\DPLA',
    function ($app) {
        return new \TFN\DPLA($_ENV['DPLA_KEY']);
    }
);
